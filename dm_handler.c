...
#define DM_PARAM_SIP_CLIENT_AUTH_USER_NAME "Device.Services.VoiceService.1.VoiceProfile.1.Line.1.SIP.AuthUserName"
#define DM_PARAM_SIP_CLIENT_AUTH_PASSWORD "Device.Services.VoiceService.1.VoiceProfile.1.Line.1.SIP.AuthPassword"
#define DM_PARAM_SIP_CLIENT_ENABLE "Device.Services.VoiceService.1.VoiceProfile.1.Line.1.Enable"
#define DM_PARAM_SIP_CLIENT_STATUS "Device.Services.VoiceService.1.VoiceProfile.1.Line.1.Status"
#define DM_PARAM_NETWORK_OUTBOUND_PROXY "Device.Services.VoiceService.1.VoiceProfile.1.SIP.OutboundProxy"
#define DM_PARAM_NETWORK_OUTBOUND_PROXY_PORT "Device.Services.VoiceService.1.VoiceProfile.1.SIP.OutboundProxyPort"
